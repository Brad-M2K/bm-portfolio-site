...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
    ...
    if (itemEls.length) {
      ...
      tl.to(
        itemEls,
        {
          ...
          duration: 1,
          ease: "power4.out",
          stagger: !isDesktop ? 0 : { each: 0.1, from: "start" },
        },
        itemsStart
      );
  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            ...
            >
              ...
              <p className="font-bold md:text-5xl text-4xl text-violet-500  pl-2 pb-1 animate-caret-blink">
                |
              </p>
            </Link>
          </div>
      ...
      <style>{`
            .sm-scope {
                    --sm-safe-area: env(safe-area-inset-bottom, 0);
                }
            .sm-scope .staggered-menu-wrapper { position: relative; width: 100%; height: 100%; z-index: 40; }
            .sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 2em; background: transparent; pointer-events: none; z-index: 20; }
            .sm-scope .staggered-menu-header > * { pointer-events: auto; }
            .sm-scope .sm-logo { display: flex; align-items: center; user-select: none; }
            .sm-scope .sm-logo-img { display: block; height: 32px; width: auto; color: #ffffff; }
            ...
            .sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: rgba(235, 226, 254, 1); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; }
            .sm-scope[data-fixed] .staggered-menu-panel { position: fixed; top: 0; bottom: 0; right: 0; left: auto; height: auto; }
            .sm-scope [data-position='left'] .staggered-menu-panel { right: auto; left: 0; }
            .sm-scope .sm-prelayers { position: absolute; top: 0; right: 0; bottom: 0; width: clamp(260px, 38vw, 420px); pointer-events: none; z-index: 5; }
            .sm-scope [data-position='left'] .sm-prelayers { right: auto; left: 0; }
            .sm-scope .sm-prelayer { position: absolute; top: 0; right: 0; height: 100%; width: 100%; transform: translateX(0); }
            .sm-scope .sm-panel-inner { flex: 1; display: flex; flex-direction: column; gap: 1.25rem; }
            .sm-scope .sm-socials { margin-top: auto; padding: 2rem 0 calc(1rem + var(--sm-safe-area)); display: flex; flex-direction: column; gap: 0.75rem; }
            ...
            @media (max-width: 640px) {
                .sm-scope .staggered-menu-panel,
                .sm-scope[data-fixed] .staggered-menu-panel {
                    width: 100%;
                    left: 0;
                    right: 0;
                    padding: 5em 1.5em calc(1.5em + var(--sm-safe-area)) 1.5em;
                }
                .sm-scope .sm-logo-img { height: 24px; }
                .sm-scope .staggered-menu-wrapper[data-open] .sm-logo-img { color: var(--sm-accent, #ff0000); }
