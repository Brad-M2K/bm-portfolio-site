  ...
  return (
    <section className="flex w-full flex-col items-center gap-4 text-white">
      ...
      <p className="text-left text-lg md:text-2xl md:pl-10 text-balance  text-gray-300 ">
        I like solving problems cleanly and working with people who care about
        what they build. I’m big on efficiency, good communication, and finding
        smarter ways to work. Outside code, I’m usually learning, making music,
        or improving something I built yesterday.
      </p>
    </section>
  );
};
