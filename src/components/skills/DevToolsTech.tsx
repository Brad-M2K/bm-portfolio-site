  ...
  return (
    <section className="flex w-full flex-col items-center gap-4 text-white">
      ...
      <p className="text-left text-lg md:text-2xl md:pl-10 text-balance text-gray-300 ">
        I manage code through GitHub and deploy mainly on Vercel. I write tests
        with Jest for backend and API work, design small touches in Figma, and
        like trying out new tools — recently WebStorm, sometimes n8n for
