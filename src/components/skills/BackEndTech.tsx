  ...
  return (
    <section className="flex w-full flex-col items-center gap-4 text-white">
      ...
      <p className="text-left text-lg md:text-2xl md:pl-10 text-balance text-gray-300">
        On the server side I lean on Node.js with Prisma for data access,
        Supabase for auth and storage, and PostgreSQL as a solid, reliable base
        — with some experience building APIs in Express and raw SQL too.
      </p>
    </section>
  );
};
